...
Living specs: `docs/specs/` (customizable-ui-inventory, css-architecture, asset-manifest). Evidence base: `docs/research/phase1-research-findings.md`. **The open plan is [`docs/plans/0004-codex-owl-token-remap.md`](plans/0004-codex-owl-token-remap.md)** (opened 2026-09-23): Codex `26.917` moved onto its "OWL" runtime and renamed the hooks the theme hangs on, so **the shipped theme currently renders stock** — the injector still attaches and inserts cleanly. Its M1 inventory is [`docs/research/owl-token-inventory.md`](research/owl-token-inventory.md). The previous plan, `docs/plans/0003-image-led-theme-authoring.md` (the theme-authoring pipeline), closed 2026-08-05; `docs/plans/0001-captains-cabin-architecture.md` is the architecture authority and the Phase 1–4 record.
