...
Living specs: `docs/specs/` (customizable-ui-inventory, css-architecture, asset-manifest). Evidence base: `docs/research/phase1-research-findings.md`. **No plan is currently open** — the most recent, `docs/plans/0003-image-led-theme-authoring.md` (the theme-authoring pipeline), closed 2026-08-05; `docs/plans/0001-captains-cabin-architecture.md` is the architecture authority and the Phase 1–4 record.
