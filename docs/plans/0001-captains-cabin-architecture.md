...
**Phase 4 (packaging) is now unblocked and is the next work.** **Dialogs** remain the only surface never observed; Codex's settings screen carries no `[role=dialog]` and may simply not have one — report opportunistically, do not build a run for it.
